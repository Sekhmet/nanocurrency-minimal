...
function cryptoVerify32(x: Uint8Array, xi: number, y: Uint8Array, yi: number): number {
...
function cryptoSign(sm: Uint8Array, m: Uint8Array, n: number, sk: Uint8Array): number {
...
function cryptoSignOpen(m: Uint8Array, sm: Uint8Array, n: number, pk: Uint8Array): number {
  let i
  let mlen
